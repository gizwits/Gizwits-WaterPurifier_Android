...
Gizwits Water purifier Android Demo App
...
项目工程结构
    ...
    ▪包结构说明
    com.gizwits.waterpurifier                              -智能云净水器独有代码，包含控制部分和侧边栏部分
    com.gizwits.waterpurifier.activity.control             -智能云净水器控制界面activity
...
使用流程
    ...
    2.下载gokit开源代码并按说明替换为机智云智能净水器的产品标识码
    3.在app上注册并登录帐号
